pipeline {
    ...
    stages {
        ...
        stage('S3Copy') {
            steps {
                s3Upload acl: 'Private', bucket: '30daysdevops/dropwizard/release', cacheControl: '', excludePathPattern: '', file: 'target/dropwizard-example-${BUILD_NUMBER}.jar', metadatas: [''], sseAlgorithm: '', workingDir: ''
